...
'use client'
import { MenuBar } from "@/components/text-editer/menu-bar";
...
export const ModalBlogForm = ({ initialValues, isEdit = false, onClose }: Props) => {
    ...
    const [fileList, setFileList] = useState<any[]>(() => isEdit ? handleProcessImage(initialValues?.image || '') : []);
    ...
    const handleGetTextEditor = (data: string | undefined) => {
        setTextEditor(data || '');        
    }
        ...
        >
            ...
            >
                ...
                <Form.Item label={'Description'}>
                    <MenuBar onChange={handleGetTextEditor} initValue={initialValues?.content || ''}/>
                </Form.Item>
            </Form>
            {previewImage && (
                <Image
